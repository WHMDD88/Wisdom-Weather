...
def train(train_inout,lstm_model,name,y_name):
    ...
    torch.save(lstm_model.state_dict(), 'model_param/1-1_lstm_model.pth')
...
def predict(test_data,scaler,name,y_name):
    ...
    lstm_model.load_state_dict(torch.load('model_param/1-1_lstm_model.pth'))
    lstm_model.eval()
